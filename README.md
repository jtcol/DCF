...
estimate is shown as a reference figure next to Stage-1 growth, so you can see the market's
forward view — but it is **never applied automatically**; you decide whether to adopt it.
